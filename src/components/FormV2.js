...
class FormV2 extends Component {
  constructor(props) {
    ...
    if (storage !== null) {
      let stateData = JSON.parse(storage)
      stateData.startDate = moment(stateData.startDate).format('YYYY-MM-DD')
      stateData.endDate = moment(stateData.endDate).format('YYYY-MM-DD')
        ...
        <form action="" className="input-form" onSubmit={this.handleSubmit}>
          ...
          <div className="analysis-params-container add-bottom-margin">
            ...
            <div className="input-container">
              ...
              <input
                type="number"
                value={stockPricePaths}
                onChange={this.handleFormChange}
                name="stockPricePaths"
              />
            </div>
            <div className="input-container long-input-field">
          ...
          <div className="input-vars-container add-bottom-margin">
            ...
            <div className="input-container">
              ...
              <input
                type="number"
                value={modelPeriodSpendCap}
                onChange={this.handleFormChange}
                name="modelPeriodSpendCap"
              />
            </div>
            <div className="input-container">
          ...
          <div className="input-tables-container">
            <table className="input-table-1">
              ...
              <tr>
                ...
                <td className="border-bottom-right-radius">
                  <input
                    type="number"
                    value={dailySpend4}
                    onChange={this.handleFormChange}
            ...
            <table className="input-table-2">
              ...
              <tr>
                <td>
                  <input type="text" value="Par" disabled="true" />
                </td>
                <td>
                  <input
                    type="number"
              ...
              <tr>
                <td>
                  <input type="text" value="2% Below" disabled="true" />
                </td>
                <td>
                  <input
                    type="number"
                    value={dailySpendPercent2Below}
                    onChange={this.handleFormChange}
                    name="dailySpendPercent2Below"
                  />
                </td>
                <td>
                  <input
              ...
              <tr>
                <td>
                  <input type="text" value="4% Below" disabled="true" />
                </td>
                <td>
                  <input
                    type="number"
                    value={dailySpendPercent4Below}
                    onChange={this.handleFormChange}
                    name="dailySpendPercent4Below"
                  />
                </td>
                <td>
                  <input
